...
import { userReset } from '../reducer/User'
...
export default function Header() {
   ...
   * @function useEffect
   * @param { Object } store initial state with status 'void'
   ...
   * 
   * if email or password is empty or if email or password doesn't corresponds to a registered user in database
